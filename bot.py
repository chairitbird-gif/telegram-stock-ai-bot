...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        ...
        "คำสั่ง:\n"
        "/movers — สรุปหุ้นวันนี้ + มูลค่าเหมาะสม\n"
        "/market — ภาพรวมตลาด สหรัฐฯ+ทองคำ+SET ไทย\n"
...
async def post_init(app: Application) -> None:
    ...
    await app.bot.set_my_commands(
        [
            ...
            BotCommand("movers", "สรุปหุ้นวันนี้ ทำไมขึ้น/ลง + มูลค่าเหมาะสม"),
            BotCommand("market", "ภาพรวมตลาด สหรัฐฯ+ทองคำ+SET ไทย"),
